...
<body>
			...
			<div class="navigation">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav " >
						...
						<li class="active"><a href='<?php echo $url = "Cases.php";?>'>Cases</a></li>
	...
	<div class="practice">
		...
		<div class="col-md-4 practice-left">
			<h3 style="margin: 1px 20px 22px;">Cases</h3>
				<ul>
					...
					<li><a href="#"><span></span>intellectual property </a></li>
					<li><a href="#"><span></span>Criminal Law</a></li>	
					<li><a href="#"><span></span>Business Law </a></li>
					<li><a href="#"><span></span>Malpractice Law </a></li>
					<li><a href="#"><span></span>Family Law</a></li>
					<li><a href="#"><span></span>Insurance Law</a></li>
					<li><a href="#"><span></span>Security Law</a></li>	
				</ul>
		</div>
		<div class="col-md-8 practice-right">
			<h3 style="margin: 1px 20px 22px;">Practice Center</h3>
			...
			<div class="clearfix"></div>
				<p> Fusce suscipit varius mi. Cum sociis natoque penatibus et magnis dis parturient montes,Fusce suscipit varius mi. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridicu-lus mus. Nulla dui. Fusce feugiat malesuada odio nascetur ridicu-lus mus. Nulla dui. Fusce feugiat malesuada odio</p>
				
		</div>
		<div class="clearfix"></div>
		<div class="pra-tp">
			<h3 style="margin: 1px 20px 22px;">Winning Cases</h3>
	...
	<div class="container">
		...
		<label class="form-label" for="customFile">Cases Upload</label>
		<br><br>
